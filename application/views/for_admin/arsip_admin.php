      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Arsipkan Sekarang <?php echo $this->session->nama; ?></h2>
        ...
        <div class="col-xs-8 col-sm-8 col-md-8 col-lg-8">
           ...
           <div class="form-group">
             ...
             <input type="text" class="form-control" id="" placeholder="Nomor Surat" name="nomorsurat">
             <br>
             <label for="">Organisasi</label>
             <select name="" id="input" class="form-control" required="required" name="organisasi">
             <option value=""></option></select>
             <br>
             <label for="">Jenis</label>
             <select name="" id="input" class="form-control" required="required">
             <option value="Peminjaman Gedung">Peminjaman Gedung</option>
